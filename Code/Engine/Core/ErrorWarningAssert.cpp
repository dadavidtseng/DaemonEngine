...
bool IsDebuggerAvailable()
{
	...
	static IsDebuggerPresentFunc* isDebuggerPresentFunc = (IsDebuggerPresentFunc*)GetProcAddress(
...
int SystemDialogue_YesNoCancel(std::string const&     messageTitle, std::string const& messageText,
                               const MsgSeverityLevel severity)
{
	int answerCode = 1;
...
//-----------------------------------------------------------------------------------------------
__declspec(noreturn) void FatalError(char const*        filePath, char const*       functionName, const int lineNum,
                                     std::string const& reasonForError, char const* conditionText)
{
	...
	const std::string appName          = "Unnamed Application"; // #ToDo: replace with fetch from global config strings
	const std::string fullMessageTitle = appName + " :: Error";
	std::string       fullMessageText  = errorMessage;
	fullMessageText += "\n\nThe application will now close.\n";
	const bool isDebuggerPresent = (IsDebuggerPresent() == TRUE);
...
//-----------------------------------------------------------------------------------------------
void RecoverableWarning(char const* filePath, char const* functionName, int lineNum, std::string const& reasonForWarning,
                        char const* conditionText)
{
	...
	char const*       fileName          = FindStartOfFileNameWithinFilePath(filePath);
	const std::string appName           = "APP"; // #ToDo: replace with fetch from global config strings
	const std::string fullMessageTitle  = appName + " :: Warning";
	std::string       fullMessageText   = errorMessage;
	const bool        isDebuggerPresent = IsDebuggerPresent() == TRUE;
