...
public:
    ...
    void           AddVertsForText3DAtOriginXForward(VertexList_PCU& verts, String const& text, float cellHeight, Rgba8 const& tint = Rgba8::WHITE, float cellAspectRatio = 1.f, Vec2 const& alignment = Vec2(0.5f, 0.5f), int maxGlyphsToDraw = INT_MAX);
