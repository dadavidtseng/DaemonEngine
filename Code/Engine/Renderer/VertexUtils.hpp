...
void AddVertsForOBB3D(VertexList_PCUTBN& verts, IndexList& indexes, OBB3 const& obb3, Rgba8 const& color = Rgba8::WHITE, AABB2 const& UVs = AABB2::ZERO_TO_ONE);
...
void AddVertsForQuad3D(VertexList_PCU& verts, IndexList& indexes, Vec3 const& bottomLeft, Vec3 const& bottomRight, Vec3 const& topLeft, Vec3 const& topRight, Rgba8 const& color = Rgba8::WHITE, AABB2 const& UVs = AABB2::ZERO_TO_ONE);
