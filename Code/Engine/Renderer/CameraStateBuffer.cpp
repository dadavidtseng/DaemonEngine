	...
	*m_frontBuffer = *m_backBuffer;
	...
	for (auto const& [cameraId, cameraState] : *m_frontBuffer)
	{
		...
		if (cameraState.type == "world")
		{
			...
			cameraToRender.m_values[Mat44::Ix] =  0.0f;  cameraToRender.m_values[Mat44::Iy] =  0.0f;
			cameraToRender.m_values[Mat44::Iz] =  1.0f;  cameraToRender.m_values[Mat44::Iw] =  0.0f;
			cameraToRender.m_values[Mat44::Jx] = -1.0f;  cameraToRender.m_values[Mat44::Jy] =  0.0f;
			cameraToRender.m_values[Mat44::Jz] =  0.0f;  cameraToRender.m_values[Mat44::Jw] =  0.0f;
			cameraToRender.m_values[Mat44::Kx] =  0.0f;  cameraToRender.m_values[Mat44::Ky] =  1.0f;
			cameraToRender.m_values[Mat44::Kz] =  0.0f;  cameraToRender.m_values[Mat44::Kw] =  0.0f;
			cameraToRender.m_values[Mat44::Tx] =  0.0f;  cameraToRender.m_values[Mat44::Ty] =  0.0f;
			cameraToRender.m_values[Mat44::Tz] =  0.0f;  cameraToRender.m_values[Mat44::Tw] =  1.0f;
