...
bool Triangle2::IsPointInside(Vec2 const& point) const
{
	...
	Vec2 v0 = m_positionCounterClockwise[1] - m_positionCounterClockwise[0];
	Vec2 v1 = m_positionCounterClockwise[2] - m_positionCounterClockwise[0];
	Vec2 v2 = point - m_positionCounterClockwise[0];

	float dot00 = DotProduct2D(v0, v0);
	float dot01 = DotProduct2D(v0, v1);
	float dot02 = DotProduct2D(v0, v2);
	float dot11 = DotProduct2D(v1, v1);
	float dot12 = DotProduct2D(v1, v2);
