...
//----------------------------------------------------------------------------------------------------
NetworkWebSocketSubsystem::NetworkWebSocketSubsystem(sChromeDevToolsConfig config, ScriptSubsystem* scriptSubsystem)
...
//----------------------------------------------------------------------------------------------------
NetworkWebSocketSubsystem::~NetworkWebSocketSubsystem()
{
    Stop();
}

//----------------------------------------------------------------------------------------------------
bool NetworkWebSocketSubsystem::Start()
{
    ...
    // Start server thread
    m_serverThread = std::thread(&NetworkWebSocketSubsystem::ServerThreadMain, this);
...
//----------------------------------------------------------------------------------------------------
void NetworkWebSocketSubsystem::Update()
{
...
//----------------------------------------------------------------------------------------------------
void NetworkWebSocketSubsystem::Stop()
{
...
//----------------------------------------------------------------------------------------------------
bool NetworkWebSocketSubsystem::IsRunning() const
{
    return m_isRunning;
}

//----------------------------------------------------------------------------------------------------
bool NetworkWebSocketSubsystem::HasActiveConnections() const
{
    return !m_activeConnections.empty();
}

//----------------------------------------------------------------------------------------------------
int NetworkWebSocketSubsystem::GetPort() const
{
    return m_config.port;
}

//----------------------------------------------------------------------------------------------------
void NetworkWebSocketSubsystem::SetInspector(v8_inspector::V8Inspector*        inspector,
...
//----------------------------------------------------------------------------------------------------
void NetworkWebSocketSubsystem::SendToDevTools(const std::string& message)
{
...
//----------------------------------------------------------------------------------------------------
void NetworkWebSocketSubsystem::ServerThreadMain()
{
    ...
    while (!m_shouldStop && m_isRunning)
    {
        ...
        m_clientThreads.emplace_back(&NetworkWebSocketSubsystem::ClientHandlerThread, this, clientSocket);
...
//----------------------------------------------------------------------------------------------------
void NetworkWebSocketSubsystem::ClientHandlerThread(SOCKET const clientSocket)
{
...
//----------------------------------------------------------------------------------------------------
void NetworkWebSocketSubsystem::OnClientConnected(SOCKET const clientSocket)
{
...
//----------------------------------------------------------------------------------------------------
void NetworkWebSocketSubsystem::OnClientDisconnected(SOCKET const clientSocket)
{
...
//----------------------------------------------------------------------------------------------------
void NetworkWebSocketSubsystem::ProcessHttpRequest(SOCKET const  clientSocket,
...
//----------------------------------------------------------------------------------------------------
std::string NetworkWebSocketSubsystem::HandleDiscoveryRequest()
{
...
//----------------------------------------------------------------------------------------------------
std::string NetworkWebSocketSubsystem::CreateHttpResponse(const std::string& content,
...
//----------------------------------------------------------------------------------------------------
bool NetworkWebSocketSubsystem::ProcessWebSocketUpgrade(SOCKET clientSocket, const std::string& request)
{
...
//----------------------------------------------------------------------------------------------------
void NetworkWebSocketSubsystem::ProcessWebSocketMessage(SOCKET clientSocket, const std::string& data)
{
    if (data.empty())
    {
        return;
...
//----------------------------------------------------------------------------------------------------
bool NetworkWebSocketSubsystem::HandleCustomCommand(const std::string& message)
{
...
//----------------------------------------------------------------------------------------------------
std::string NetworkWebSocketSubsystem::EscapeJsonString(const std::string& input)
{
    std::string escaped;
...
//----------------------------------------------------------------------------------------------------
std::string NetworkWebSocketSubsystem::CreateWebSocketAcceptKey(const std::string& clientKey)
{
...
//----------------------------------------------------------------------------------------------------
std::string NetworkWebSocketSubsystem::DecodeWebSocketFrame(const std::string& frame)
{
...
//----------------------------------------------------------------------------------------------------
std::string NetworkWebSocketSubsystem::EncodeWebSocketFrame(const std::string& payload,
...
//----------------------------------------------------------------------------------------------------
bool NetworkWebSocketSubsystem::SendRawDataToSocket(SOCKET socket, const std::string& data)
{
...
//----------------------------------------------------------------------------------------------------
std::string NetworkWebSocketSubsystem::ReceiveDataFromSocket(SOCKET socket)
{
...
//----------------------------------------------------------------------------------------------------
void NetworkWebSocketSubsystem::CloseSocket(SOCKET socket)
{
...
//----------------------------------------------------------------------------------------------------
std::string NetworkWebSocketSubsystem::GenerateUUID()
{
...
//----------------------------------------------------------------------------------------------------
std::string NetworkWebSocketSubsystem::Base64Encode(const std::string& input)
{
...
//----------------------------------------------------------------------------------------------------
void NetworkWebSocketSubsystem::QueueInspectorMessage(const std::string& message)
{
...
//----------------------------------------------------------------------------------------------------
void NetworkWebSocketSubsystem::ProcessQueuedMessages()
{
...
//----------------------------------------------------------------------------------------------------
void NetworkWebSocketSubsystem::EnableDevToolsDomains(SOCKET clientSocket)
{
