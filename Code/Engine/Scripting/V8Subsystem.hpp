...
private:
    ...
    static void JSLog(v8::FunctionCallbackInfo<v8::Value> const& args);
    static void JSCreateCube(v8::FunctionCallbackInfo<v8::Value> const& args);
    static void JSMoveProp(v8::FunctionCallbackInfo<v8::Value> const& args);
    static void JSGetPlayerPosition(v8::FunctionCallbackInfo<v8::Value> const& args);
    static void JSSetPlayerPosition(v8::FunctionCallbackInfo<v8::Value> const& args);

    // 輔助方法
    bool BindFunction(v8::Local<v8::Context> context, v8::Local<v8::Object> object, const char* name, v8::FunctionCallback callback);
