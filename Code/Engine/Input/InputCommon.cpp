...
unsigned char const KEYCODE_F13           = 0x7C;
...
unsigned char const KEYCODE_LEFT_MOUSE    = 0x01;
unsigned char const KEYCODE_RIGHT_MOUSE   = 0x02;
...
unsigned char const KEYCODE_CONTROL       = 0x11;
